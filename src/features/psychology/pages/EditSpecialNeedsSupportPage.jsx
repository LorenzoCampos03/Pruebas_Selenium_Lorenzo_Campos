...
import { formatSupportForApi, SUPPORT_TYPES } from "../models/specialNeedsSupportModel";
...
export default function EditSpecialNeedsSupportPage() {
     const { id } = useParams();
     const { user } = useAuth();
     const navigate = useNavigate();
     const { students, institutions, classrooms, fetchById, updateSupport, fetchAll } = useSpecialNeedsSupport(user);
     ...
     useEffect(() => {
          async function load() {
               ...
               if (record) {
                    setFormData(record);
                    setAdaptationsText((record.adaptationsRequired || []).join(", "));
                    setMaterialsText((record.supportMaterials || []).join(", "));
               } else {
                    alertError("No se pudo cargar el registro de soporte", "Error");
     ...
     async function handleSubmit() {
          ...
          try {
               ...
               await updateSupport(id, payload);
               await alertCreated("Atención Especial Actualizada");
               ...
               alertError(
                    error.response?.data?.message || "No se pudo actualizar la atención",
                    "Error al guardar"
               );
          } finally {
               setSubmitting(false);
          ...
          return (
               <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-blue-50/30 to-indigo-50/20">
                    <div className="text-center">
                         ...
                         <p className="mt-4 text-gray-600">Cargando datos del soporte...</p>
                    </div>
               </div>
          );
     }
               ...
               <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-6">
                         ...
                         <div className="flex items-center justify-between">
                              <div>
                                   <h1 className="text-2xl font-bold text-gray-900 mb-1">Editar Atención Especial</h1>
                                   <p className="text-sm text-gray-600">Actualice la información del soporte de necesidades especiales de {formData.studentName || 'este alumno'}</p>
                              </div>
                    ...
                    <div className="grid grid-cols-12 gap-4">
                         ...
                         <div className="col-span-9">
                              <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                                   <div className="bg-gradient-to-r from-amber-500 via-amber-600 to-orange-600 px-6 py-4">
                                   ...
                                   <div className="p-6">
                                                  ...
                                                  <div className="grid grid-cols-2 gap-4">
                                                       <div>
                                                            ...
                                                            <select
                                                                 ...
                                                                 className={`w-full px-3 py-2.5 border-2 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all text-gray-900 text-sm ${
                                                                      formData.studentId ? "border-amber-300 bg-white" : "border-gray-300 bg-white"
                                                       ...
                                                       <div>
                                                            ...
                                                            <select
                                                                 ...
                                                                 className={`w-full px-3 py-2.5 border-2 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all bg-white text-gray-900 text-sm ${
                                                                      formData.classroomId ? "border-amber-300 bg-white" : "border-gray-300"
                                                                 }`}
                                                            >
                                                       ...
                                                       <div>
                                                            ...
                                                            <div className="relative">
                                                                 ...
                                                                 <select
                                                                      ...
                                                                      className="w-full pl-10 pr-3 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white text-gray-900 text-sm"
                                                                 >
                                                  ...
                                                  <div className="grid grid-cols-2 gap-4 pt-2 border-t">
                                                       <div className="col-span-2">
                                                            ...
                                                            <select
                                                                 ...
                                                                 className={`w-full px-3 py-2.5 border-2 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all bg-white text-gray-900 text-sm ${
                                                                      formData.supportType ? "border-amber-300 bg-white" : "border-gray-300"
                                                                 }`}
                                                            >
                                                  ...
                                                  <div className="grid grid-cols-2 gap-4">
                                                       <div className="col-span-2">
                                                            ...
                                                            <input
                                                                 ...
                                                                 className="w-full px-3 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all bg-white text-gray-900 text-sm"
                                                            />
                                                       </div>
                                                       <div>
                                             ...
                                             <div className="space-y-4">
                                                  <div>
                                                       ...
                                                       <textarea
                                                            ...
                                                            className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all text-sm"
                                                       />
                                                  </div>
                                                  ...
                                                  <div>
                                                       ...
                                                       <textarea
                                                            value={(formData.adaptationsRequired || []).join(", ")}
                                                            onChange={(e) => handleChange("adaptationsRequired", e.target.value)}
                                                            rows={2}
                                                  ...
                                                  <div>
                                                       ...
                                                       <textarea
                                                            value={(formData.supportMaterials || []).join(", ")}
                                                            onChange={(e) => handleChange("supportMaterials", e.target.value)}
                                                            rows={2}
                                                  ...
                                                  <div>
                                                       <label className="block text-xs font-semibold text-gray-700 mb-1.5">Especialista Externo Involucrado</label>
                                                       <input
                                                            type="text"
                                        ...
                                        {currentStep === 3 && (
                                             <div className="space-y-6">
                                                  ...
                                                  <div className="bg-amber-50 p-5 border border-amber-100 rounded-xl space-y-4">
                                                       <h3 className="text-sm font-bold text-amber-900 border-b border-amber-200 pb-2 flex items-center gap-2">
                                                            <Bell className="w-4 h-4 text-amber-600" />
                                                            Configuración de Notificaciones
                                                       </h3>
                                                       
                                                       <div className="space-y-3">
                                                            <label className="flex items-center gap-2 cursor-pointer bg-white px-3 py-2 border border-amber-200 rounded-lg shadow-sm w-fit hover:bg-amber-50 transition-colors">
                                                                 <input
                                                                      type="checkbox"
                                                                 ...
                                                                 />
                                                                 <span className="text-sm font-semibold text-amber-900">Notificar a los apoderados / padres de familia</span>
                                                            </label>

                                                            {formData.notifyParents && (
                                                                 <div className="pl-6 space-y-4 border-l-2 border-amber-200 ml-2 mt-2">
                                                                      <div className="space-y-2">
                                   ...
                                   <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex items-center justify-between">
                                        ...
                                        <button
                                             ...
                                             className={`px-6 py-2 text-sm font-bold text-white rounded-lg transition-all shadow-sm flex items-center gap-2 ${
                                                  submitting ? "bg-amber-400 cursor-not-allowed" : "bg-amber-600 hover:bg-amber-700 hover:shadow"
                                             }`}
                                        >
